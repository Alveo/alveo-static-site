...
The whole script is saved as a gist ([upload_children.py](https://gist.github.com/stevecassidy/087f08c1844efd5ba2d20d60d5eb5894)) but I will include code snippets below as I describe the process.
...
collection_uri = client.create_collection(name, collection_meta)  
item_uri = client.add_item(collection_uri, itemid, meta)  
client.add_document(item_uri, docname, docmeta, file=file)  
```
...
```python  
def speaker_meta(speaker, demographics):  
