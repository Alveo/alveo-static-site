...
We’re aware that this is not the easiest way to find data so we’re working on a better search interface for Austalk data in Alveo. You can see a prototype of this interface here: [austalk-query.](http://austalk-query.apps.alveo.edu.au/) To use this you need to get your [Alveo API key](/help/getting-access-to-alveo-and-galaxy/whats-an-api-key) and enter it in the first page.
